...
- Delete action is local to the current page session (hides card in-memory only).
...
- Live URL: https://senatorcode.github.io/HNG-STAGE-0/
- GitHub repo: https://github.com/SenatorCode/HNG-STAGE-0

## Notes for reviewers

- Stage 0 test IDs were preserved.
- Stage 1a test IDs and behavior were added in place.
- This stage intentionally keeps a single-card scope (not a multi-item todo app).
